...
while($row = $result->fetch_assoc()){
    $code .= "<li>".$row['id'].", ".$row['valeur'].", ".$row['date'].", ".$row['idUtilisateur'];
    $code .= "- <a href=\"supprimer.php?id=".$row['id']."\">Supprimer</a>";
    $code .= " | <a href=\"afficherPourModification.php?id=".$row['id']."\">Modifier</a></li>";
}
$code .= "</ul>";
